# -*- coding: utf-8 -*-
"""
Created on Thu May 30 10:54:06 2019
...
class ValidateWindowCtr(object):
    ...
    def trans_subplot_scroll(self, event):       
        if event.button == 'down' and (self.index_trans[-1] > 0):
    ...
    def truth_subplot_scroll(self, event):       
        if event.button == 'down' and (self.index_truth[-1] > 0):
    ...
    def segmen_subplot_scroll(self, event):       
        if event.button == 'down' and (self.index_segmen[-1] > 0):
