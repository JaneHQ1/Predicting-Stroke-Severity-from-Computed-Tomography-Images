...
"""
#   Class to Control the mouse events
class ClickController():
    # Initialize the class
    def __init__(self, fig, im_disp, vol_tran, vol_fron, vol_sagi, ax_tran, ax_fron, ax_sagi):  
        self.fig =fig
...
#            self.fig.canvas.mpl_disconnect(self.scroll_fron)
    ...
    def transverse_view(self, index):
        ...
        self.im_disp.update_transverse_display(self.ax_tran.index)
        self.fig.canvas.draw_idle()

    def frontal_view(self, index):
        self.ax_fron.index = index
        self.im_disp.update_frontal_display(self.ax_fron.index)
        self.fig.canvas.draw_idle()

    def sagittal_view(self, index):
        self.ax_sagi.index = index
        self.im_disp.update_sagittal_display(self.ax_sagi.index)
        self.fig.canvas.draw_idle()
    ...
    # Mouse scroll event to update images
